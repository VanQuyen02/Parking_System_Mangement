...
def read_plate(license_plate_character, im):
    LP_type = "1"
    results = license_plate_character(im)
    processed_image_path = "D:/Course_FPT/Term_7/DPL301/Project/Demo/test_img/image.jpg"
